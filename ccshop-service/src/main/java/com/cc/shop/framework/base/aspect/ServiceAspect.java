package com.cc.shop.framework.base.aspect;
...
public class ServiceAspect {
	 ...
	 * @throws Throwable
	 */
	@Around(value = "execution(public * com.cc.shop..service.*Service.*(..))")
...
//	@Before(value = "execution(public * com.cc.shop..service.*Service.*(..))")
//	public Object beforeServiceMethod(final JoinPoint jp) throws Throwable {
//		System.out.println("before");
//		return "";
//	}
//	
//	@After(value = "execution(public * com.cc.shop..service.*Service.*(..))")
