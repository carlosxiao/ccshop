package com.cc.shop.groupon.order.dao;
...
public class OrderDAO extends BaseMybatisDAO {
    ...
    private static final String ORDER_MAPPER_NAMESPACE = "com.cc.shop.groupon.order.entity.OrderMapper";

    private static final String ORDERDETAIL_MAPPER_NAMESPACE = "com.cc.shop.groupon.order.entity.OrderDetailMapper";
