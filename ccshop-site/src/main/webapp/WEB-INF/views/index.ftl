	...
	<body>
		<div class="banner comWidth clearfix">
			<div class="banner_bar banner_big">
				<ul class="imgBox">
					<li><a href="#"><img src="${ctx}/src/main/webapp/images/banner/banner_01.jpg" alt="banner"></a></li>
					<li><a href="#"><img src="${ctx}/src/main/webapp/images/banner/banner_02.jpg" alt="banner"></a></li>
				</ul>
				<div class="imgNum">
