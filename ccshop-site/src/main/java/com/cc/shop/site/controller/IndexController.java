package com.cc.shop.site.controller;

import com.cc.shop.site.dto.IndexCategoryDealDTO;
...
public class IndexController extends BaseSiteController {
	...
	public String index(Model model, HttpServletRequest request) {
		...
		return "src/main/webapp/WEB-INF/views/index.ftl";
	}
...
//		model.addAttribute("categoryList", categories);
		...
		return "/src/main/webapp/WEB-INF/views/search.ftl";
	}
