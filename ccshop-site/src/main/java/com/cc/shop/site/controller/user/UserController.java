package com.cc.shop.site.controller.user;
...
public class UserController extends BaseSiteController {
	...
	public String reg() {
		return "/src/main/webapp/WEB-INF/views/user/register.ftl";
	}
