package com.cc.shop.base.controller;
...
import com.cc.shop.constants.WebConstants;
import com.cc.shop.utils.CookieUtil;
import com.cc.shop.util.IpUtil;
...
import com.cc.shop.framework.util.EmailUtil;
import com.cc.shop.framework.util.EncryptionUtil;
import com.cc.shop.framework.util.RegexUtil;
import com.cc.shop.framework.util.SMSUtil;
import com.cc.shop.framework.web.controller.BaseController;
...
public class FrontendBaseController extends BaseController {
	 ...
	 *            电话号码
	 * @param action
	 *            目的，如：register(注册)、retrievePwd(找回密码)等，详见：com.cc.shop.framework.util.SMSUtil.ACTION_MAP
	 * @param sender
	 *            发送者，site、app等
	 *            
	 * @return
