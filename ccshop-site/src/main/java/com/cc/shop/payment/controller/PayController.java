package com.cc.shop.payment.controller;

import com.cc.shop.base.objects.WebUser;
import com.cc.shop.payment.Payment;
import com.cc.shop.payment.PaymentFactory;
import com.cc.shop.framework.common.Pair;
...
import com.cc.shop.groupon.order.constant.OrderConstant;
...
public class PayController extends BaseSiteController {
    ...
    public String payReturn(HttpServletRequest request, Model model) throws Exception {
        //FIXME 构造适用于支付宝返回及货到付款返回的方法,此时不再需要com.cc.shop.site.web.payment.impl.alipay.controller.AlipayController
        //1.参数从request中获取
        //2.货到付款,增加特定参数,如果有则执行我们自己的return;若无则支付宝的renturn
        model.addAttribute("result", 1);
        return "/src/main/webapp/WEB-INF/views/cart/settlement_ok.ftl";
    }
