package com.cc.shop.common.image.controller;

import com.cc.shop.base.constant.Constants;
import com.cc.shop.base.controller.BaseAdminController;
import com.cc.shop.framework.base.exception.BusinessException;
...
public class ImageController extends BaseAdminController {
	...
	public void ckeUpload(HttpServletRequest request, String module, HttpServletResponse response) {
		MultipartFile file = ((DefaultMultipartHttpServletRequest) request).getFile("upload");
		if (file.isEmpty()) {
			return;
		}
