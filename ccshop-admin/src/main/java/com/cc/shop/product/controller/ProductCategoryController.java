...
import com.cc.shop.groupon.deal.service.DealCategoryService;
...
public class ProductCategoryController extends BaseAdminController {
	...
	public @ResponseBody List<EasyUITreeNode> buildProductCategoryTree() {
	...
	public @ResponseBody AjaxResult deleteProductCategory(Long categoryId) {
	...
	public @ResponseBody AjaxResult swapProductCategoryOrderNum(Long id1, Long id2) {
